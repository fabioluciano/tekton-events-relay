...
cosign verify \
  ...
  ghcr.io/fabioluciano/tekton-events-relay:0.8.0

cosign verify \
  --certificate-identity-regexp='https://github.com/fabioluciano/tekton-events-relay' \
  --certificate-oidc-issuer='https://token.actions.githubusercontent.com' \
  oci://ghcr.io/fabioluciano/charts/tekton-events-relay:0.8.0
```
...
| config.scm.azure_devops | list | `[{"actions":[{"enabled":false,"name":"commit-status","type":"commit_status","when":""},{"enabled":false,"labels":{"add":[{"color":"0e8a16","name":"build-passed"}],"remove":[{"name":"build-failed"}]},"name":"label","type":"label","when":""}],"base_url":"https://dev.azure.com","enabled":false,"genre":"tekton-ci","insecure_skip_verify":false,"name":"default"}]` | Azure DevOps SCM provider configuration |
| config.scm.azure_devops[0].actions | list | `[{"enabled":false,"name":"commit-status","type":"commit_status","when":""},{"enabled":false,"labels":{"add":[{"color":"0e8a16","name":"build-passed"}],"remove":[{"name":"build-failed"}]},"name":"label","type":"label","when":""}]` | Actions to perform when events are received |
...
| config.scm.azure_devops[0].actions[1].labels | object | `{"add":[{"color":"0e8a16","name":"build-passed"}],"remove":[{"name":"build-failed"}]}` | Declarative label effect: add/remove lists with optional colors (hex without #) |
...
| config.scm.gitea | list | `[{"actions":[{"enabled":false,"name":"commit-status","type":"commit_status","when":""},{"enabled":false,"name":"pr-comment","template":{"configmapRef":{"key":"bitbucket-comment.tmpl"}},"type":"pr_comment","when":"stateIn(\"success\", \"failure\")"},{"enabled":false,"name":"issue-comment","template":{"configmapRef":{"key":"bitbucket-comment.tmpl"}},"type":"issue_comment","when":"stateIn(\"failure\", \"error\")"},{"enabled":false,"labels":{"add":[{"color":"0e8a16","name":"ci:passed"}],"remove":[{"name":"ci:failed"}]},"name":"label","type":"label","when":""}],"base_url":"https://gitea.company.example.com","enabled":false,"name":"default"}]` | Gitea SCM provider configuration |
| config.scm.gitea[0].actions | list | `[{"enabled":false,"name":"commit-status","type":"commit_status","when":""},{"enabled":false,"name":"pr-comment","template":{"configmapRef":{"key":"bitbucket-comment.tmpl"}},"type":"pr_comment","when":"stateIn(\"success\", \"failure\")"},{"enabled":false,"name":"issue-comment","template":{"configmapRef":{"key":"bitbucket-comment.tmpl"}},"type":"issue_comment","when":"stateIn(\"failure\", \"error\")"},{"enabled":false,"labels":{"add":[{"color":"0e8a16","name":"ci:passed"}],"remove":[{"name":"ci:failed"}]},"name":"label","type":"label","when":""}]` | Actions to perform when events are received |
...
| config.scm.gitea[0].actions[3].labels | object | `{"add":[{"color":"0e8a16","name":"ci:passed"}],"remove":[{"name":"ci:failed"}]}` | Declarative label effect: add/remove lists with optional colors (hex without #) |
...
| config.scm.github | list | `[{"actions":[{"enabled":false,"name":"commit-status","type":"commit_status","when":"event.Resource == \"pipelinerun\""},{"enabled":false,"name":"check-run","template":{"configmapRef":{"key":"github-checkrun.tmpl"}},"type":"check_run","when":"stateIn(\"success\", \"failure\", \"error\")"},{"enabled":false,"name":"deployment-status","type":"deployment_status","when":"stateIn(\"success\", \"failure\")"},{"enabled":false,"mode":"create","name":"pr-comment","template":{"configmapRef":{"key":"github-pr-comment.tmpl"}},"type":"pr_comment","when":"stateIn(\"success\", \"failure\")"},{"enabled":false,"name":"issue-comment","template":{"configmapRef":{"key":"github-issue-comment.tmpl"}},"type":"issue_comment","when":"stateIn(\"failure\", \"error\")"},{"enabled":false,"name":"discussion-comment","template":{"configmapRef":{"key":"github-discussion-comment.tmpl"}},"type":"discussion_comment","when":"stateIn(\"success\", \"failure\")"},{"enabled":false,"labels":{"add":[{"color":"0e8a16","name":"ci:passed"},{"name":"ready-to-merge"}],"remove":[{"name":"ci:failed"}]},"name":"label","type":"label","when":"event.Resource == \"pipelinerun\""}],"auth":{"secretRef":{"key":"token","name":"github-default-token"}},"base_url":"https://api.github.com","enabled":false,"name":"default"}]` | GitHub SCM provider configuration |
...
| config.scm.github[0].actions[6].labels | object | `{"add":[{"color":"0e8a16","name":"ci:passed"},{"name":"ready-to-merge"}],"remove":[{"name":"ci:failed"}]}` | Declarative label effect: add/remove lists with optional colors (hex without #) |
...
| config.scm.gitlab[1].actions | list | `[{"enabled":false,"name":"commit-status","type":"commit_status","when":""},{"enabled":false,"name":"pr-comment","template":{"configmapRef":{"key":"gitlab-note.tmpl"}},"type":"pr_comment","when":"stateIn(\"failure\", \"error\")"},{"enabled":false,"name":"issue-comment","template":{"configmapRef":{"key":"gitlab-note.tmpl"}},"type":"issue_comment","when":"stateIn(\"failure\", \"error\")"},{"enabled":false,"labels":{"add":[{"color":"0e8a16","name":"pipeline::success"}],"remove":[{"name":"pipeline::failed"}]},"name":"label","type":"label","when":""}]` | Actions to perform when events are received |
...
| config.scm.gitlab[1].actions[3].labels | object | `{"add":[{"color":"0e8a16","name":"pipeline::success"}],"remove":[{"name":"pipeline::failed"}]}` | Declarative label effect: add/remove lists with optional colors (hex without #) |
