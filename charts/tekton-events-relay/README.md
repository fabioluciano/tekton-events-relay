...
![Version: 0.7.4-rc.1](https://img.shields.io/badge/Version-0.7.4--rc.1-informational?style=flat-square) ![Type: application](https://img.shields.io/badge/Type-application-informational?style=flat-square) ![AppVersion: 0.7.4-rc.1](https://img.shields.io/badge/AppVersion-0.7.4--rc.1-informational?style=flat-square)
...
cosign verify \
  ...
  ghcr.io/fabioluciano/tekton-events-relay:0.7.4-rc.1

cosign verify \
  --certificate-identity-regexp='https://github.com/fabioluciano/tekton-events-relay' \
  --certificate-oidc-issuer='https://token.actions.githubusercontent.com' \
  oci://ghcr.io/fabioluciano/charts/tekton-events-relay:0.7.4-rc.1
```
