...
func (r *StatusReporter) Name() string              { return "sourcehut" }
...
func (r *StatusReporter) Handle(ctx context.Context, e domain.Event) error {
	...
	if err := scm.Validate("sourcehut", "status_description", e.Description); err != nil {
		return err
	}
...
`,
		...
		sourcehutStateMap.Map(e.State, "pending"),
		e.Description,
		exitFor(e.State),
	)
...
var sourcehutStateMap = scm.StateMap{
