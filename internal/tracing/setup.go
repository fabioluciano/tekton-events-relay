...
func InitGlobal(ctx context.Context, endpoint, serviceName string, insecure bool, sampleRate float64, log *zap.Logger) (*sdktrace.TracerProvider, func(), error) {
	tp, err := Init(ctx, endpoint, serviceName, insecure, sampleRate)
	if err != nil {
